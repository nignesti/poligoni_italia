...
// Il nome struttura arriva da (gestore)/layout.tsx (Server Component, legge
// range_managers) — questo componente resta client solo per sidebar/nav.
// ---------------------------------------------------------------------------
...
const MINIMAL_PATHS = ['/gestore/login', '/gestore/rivendica', '/gestore/reset-password'];
