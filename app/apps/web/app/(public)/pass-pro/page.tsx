      ...
      <section className="bg-surface-sunken py-20">
        <Container>
          <div className="mx-auto max-w-xl text-center">
            <h2 className="text-3xl font-semibold text-ink">Cosa sblocca Pass Pro</h2>
            ...
            {PREMIUM_FEATURES.map((f) => {
              ...
              return (
                <div key={f.feature} className="rounded-panel border border-hairline bg-surface p-8 shadow-panel">
                  ...
                  <h3 className="mt-4 text-lg font-semibold text-ink">{f.label}</h3>
        ...
        <Container>
          ...
          <div className="mx-auto mt-12 grid max-w-3xl items-start gap-6 sm:grid-cols-2">
            ...
            <div className="relative flex flex-col gap-6 rounded-panel border border-hairline bg-surface p-8 shadow-panel">
              <div>
                <h3 className="text-lg font-semibold text-ink">Gratuito</h3>
                <p className="mt-1">
              ...
              <a
                href="/cerca"
                className="mt-auto rounded-control border border-hairline-strong px-6 py-3 text-center text-sm font-semibold text-ink hover:border-accent hover:text-accent"
              >
                Inizia gratis
              </a>
            </div>
            ...
            <div className="relative flex flex-col gap-6 rounded-panel border border-accent bg-surface p-8 shadow-panel">
              ...
              <div>
                <h3 className="text-lg font-semibold text-ink">Pass Pro</h3>
                <p className="mt-1">
              ...
              <a
                ...
                className="mt-auto rounded-control bg-accent px-6 py-3 text-center text-sm font-semibold text-accent-ink hover:bg-accent-hover"
              >
                Passa a Pro
              </a>
            </div>
