    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="px-4 py-4">
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-800 mb-4">
          <h3 className="font-semibold text-slate-900 dark:text-white text-sm">{range.name}</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400">{range.comune}, {range.provincia}</p>
        ...
        <div className="space-y-3">
          <div>
            <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Nome e cognome</label>
            <input
              type="text"
              value={form.name}
          ...
          <div>
            <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Data desiderata</label>
            <input
              type="date"
          ...
          <div>
            <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Orario preferito</label>
            <input
              type="text"
          ...
          <div>
            <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Messaggio</label>
            <textarea
              value={form.message}
              onChange={(e) => setForm({ ...form, message: e.target.value })}
              placeholder="Es. vorrei prenotare una linea per 9x21, sono disponibile anche in altri giorni..."
              className="w-full mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[100px]"
            />
          </div>
